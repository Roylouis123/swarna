...
export default function Bestow() {
  ...
  const fetchData = () => {
    ...
    onSnapshot(querys, (querySnapshot) => {
      ...
      console.log(filterboy, "filterboy");
  ...
  const handleClick = (data) => {
    ...
    const filteredProducts = filter(product, (p) => p.Id);
      ...
      >
        ...
        >
          ...
          <Stack direction="row" spacing={1} my={1} alignItems="center">
            <Typography variant="p" sx={{ color: "black", width: "rem" }}>
              {" "}
              Types :{" "}
            </Typography>
          ...
          <Stack direction="row" spacing={1} my={1} alignItems="center">
            <Typography variant="p" sx={{ color: "black", width: "4rem" }}>
              {" "}
              Models :{" "}
            </Typography>
              ...
              {map(selectedProductName, (o, i) =>
                map(o.selectedColors, (u) => (
                  <Box
                    ...
                    xs="auto"
                    sx={{ marginTop: "5px", marginLeft: "5px" }}
                    onClick={() => handleColorsClick(u.Colors)}
                  >
                    <Chip
                      key={i}
                      label={u.Colors}
              ...
              {map(selectedProductName, (o, i) =>
                map(o.selectedstroke, (u) => (
                  <Box
                    item
                    xs="auto"
                    onClick={() => handlestrokeClick(u.Stroke)}
                  >
                    <Chip
                      key={i}
                      label={u.Stroke}
